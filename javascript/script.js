    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            if (href.startsWith('#')) {
                ...
                if (targetElement) {
                    // Calcular offset baseado na altura do header
                    const headerHeight = header.offsetHeight;
                    const offsetTop = targetElement.offsetTop - headerHeight - 20; // 20px de margem
...
function initCounters() {
    // Apenas seleciona elementos com data-target (números para animar)
...
function animateCounter(element) {
    ...
    // Se não tem data-target ou não é um número válido, não anima
...
console.log(`
🌿 Bem-vinda ao site da Layane Spindola! 🌿
